...
function animationDataReducer(state: AnimationDataState, action: any) {
  switch (action.type) {
    ...
    case AnimationDataActions.deleteAnimationEntryConnection: {
      const animationData = cloneObject(
        deleteAnimationEntryConnection(
          state.animationData,
          action.animationEntryId,
          action.animationDefinitionId,
          action.local
        )
      );
      return {
    ...
    case AnimationDataActions.addAnimationEntry: {
      const animationData = cloneObject(
        addAnimationEntry(state.animationData, action.animationEntry)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.editAnimationEntry: {
      const animationData = cloneObject(
        editAnimationEntry(state.animationData, action.animationEntry)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.deleteAnimationEntry: {
      const animationData = cloneObject(
        deleteAnimationEntry(state.animationData, action.animationEntryId)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.addAnimationDefinition: {
      const animationData = cloneObject(
        addAnimationDefinition(state.animationData, action.animationDefinition)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.editAnimationDefinition: {
      const animationData = cloneObject(
        editAnimationDefinition(state.animationData, action.animationDefinition)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.editTimeline: {
      const animationData = cloneObject(
        editTimeline(state.animationData, action.timeline)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.addTimeline: {
      const animationData = cloneObject(
        addTimeline(state.animationData, action.timeline)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.deleteTimeline: {
      const animationData = cloneObject(
        deleteTimeline(state.animationData, action.timelineId)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.addEditNumberVariable: {
      ...
      const animationData = cloneObject(
        saveAnimationDataNumbers(state.animationData)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.addBreakpoint: {
      const animationData = cloneObject(
        addBreakpoint(state.animationData, action.breakpoint)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.editBreakpoint: {
      const animationData = cloneObject(
        editBreakpoint(state.animationData, action.breakpoint)
      );
      return {
        ...state,
        animationData,
    ...
    case AnimationDataActions.deleteBreakpoint: {
      const animationData = cloneObject(
        deleteBreakpoint(state.animationData, action.breakpointId)
      );
      return {
        ...state,
        animationData,
...
const AnimationDataDispatchContext = React.createContext<Dispatch | undefined>(
  undefined
);
const AnimationDataStateContext = React.createContext<
  AnimationDataState | undefined
>(undefined);
...
function useAnimationDataState() {
  ...
  if (context === undefined) {
    throw new Error(
      "useAnimationDataState must be used within a AnimationDataProvider"
    );
  }
  return context;
}
...
function useAnimationDataDispatch() {
  ...
  if (context === undefined) {
    throw new Error(
      "useAnimationDataDispatch must be used within a AnimationDataProvider"
    );
  }
  return context;
}
